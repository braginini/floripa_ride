	...
	public List<Relation> getRelationsWithTagSimple(String tagKey, String tagValue) {
		...
		try {
			...
			String SQL = "SELECT r.id FROM relations r, relation_tags t " +
                    ...
                    "3110136,1770836,3316375,2135778,2135777,2163894,2163893,3115537,3115538, 3403655,3403654,2163894," +
                    "2163893,3117522,2234308,2790253,2790252,2079722,2079727,2222978,3404020,3117522,2234308,2940034," +
                    "3404053,2260426,2372197,1864107,1864109,3289816,3289817,2291868,2291869,2790254,2790255,1864110," +
                    "1864108,3328625,3328626,3316427,2506809,2351080,3414431,2661768,2661769,2361104,3414496,2403619) " +
					"AND t.k = '" + tagKey +"' " +
					"AND t.v = '" + tagValue +"' " +
					"GROUP BY r.id";
